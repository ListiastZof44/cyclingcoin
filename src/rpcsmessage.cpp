...
Value smsgoptions(const Array& params, bool fHelp)
{
    ...
    if (mode == "list")
    {
        result.push_back(Pair("cyclingcoin", std::string("newAddressRecv = ") + (smsgOptions.fNewAddressRecv ? "true" : "false")));
        result.push_back(Pair("cyclingcoin", std::string("newAddressAnon = ") + (smsgOptions.fNewAddressAnon ? "true" : "false")));
    ...
    if (mode == "set")
    {
        ...
        if (optname == "newAddressRecv")
        {
            ...
            result.push_back(Pair("set cyclingcoin", std::string("newAddressRecv = ") + (smsgOptions.fNewAddressRecv ? "true" : "false")));
        } else
        if (optname == "newAddressAnon")
        {
            ...
            result.push_back(Pair("set cyclingcoin", std::string("newAddressAnon = ") + (smsgOptions.fNewAddressAnon ? "true" : "false")));
        } else
        {
    ...
    } else
    {
        ...
        result.push_back(Pair("expected", "smsgcyclingcoin [list|set <optname> <value>]"));
    };
    return result;
}
