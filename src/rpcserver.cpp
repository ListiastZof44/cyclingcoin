...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use cyclingcoind";
        if (mapArgs.count("-server"))
            strWhatAmI = strprintf(_("To use the %s cyclingcoin"), "\"-server\"");
        else if (mapArgs.count("-daemon"))
            strWhatAmI = strprintf(_("To use the %s cyclingcoin"), "\"-daemon\"");
