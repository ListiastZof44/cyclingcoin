...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCYCAmount"))
        settings.setValue("nAnonymizeCYCAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCYCAmount = settings.value("nAnonymizeCYCAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeCYCAmount"))
        SoftSetArg("-anonymizecyclingcoinamount", settings.value("nAnonymizeCYCAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeCYCAmount:
            nAnonymizeCYCAmount = value.toInt();
            settings.setValue("nAnonymizeCYCAmount", nAnonymizeCYCAmount);
            emit anonymizeCYCAmountChanged(nAnonymizeCYCAmount);
            break;
        default:
            break;
        }
